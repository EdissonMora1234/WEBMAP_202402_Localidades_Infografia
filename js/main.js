document.addEventListener('DOMContentLoaded', function() {
    ...
    var wmsLayers = [
        { url: 'https://geoserver.scrd.gov.co/geoserver/Arcgis_online_DOGCC/wms', layerName: 'Arcgis_online_DOGCC:Malla vial integral Bogotá DC', displayName: 'Malla vial integral Bogotá DC' },
        { url: 'https://geoserver.scrd.gov.co/geoserver/Arcgis_online_DOGCC/wms', layerName: 'Arcgis_online_DOGCC:UPZ Bogotá', displayName: 'UPZ Bogotá' },
